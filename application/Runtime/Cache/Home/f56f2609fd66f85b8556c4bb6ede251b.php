...
<head>
	...
	<script type="text/javascript" src="/shouji/Public/Home/js/succeed.js"></script> 
</head>
<body id="succeed-big">
	<div class="succeed-big">
		<div class="succeed-img">
			<img src="/shouji/Public/Home/images/succeed.png">
		</div>
		<p class="succeed-title">订单提交成功！</p>
		<p>安静地泡上一杯咖啡等待吧,</p>
		<p>修立达的维修工程师马上就会联系你。</p>
		<div class="succeed-footer">
			<p>本页面将在 <b></b> 秒后自动关闭，自动跳转回首页</p>
			<p>可以点击 <a href="/shouji/index.php/Orderinfo/index">查询订单>></a>了解当前状态</p>
		</div>
	</div>	
</body>
</html>